...
WHERE pk.kode_jurusan = 'A'
GROUP BY pk.id_paket_kursus, pk.kode, pk.nama_paket, pk.jp, pk.harga, pk.kode_jurusan;
");
$materi_q = mysqli_query($koneksi, "SELECT * FROM materi ORDER BY nama_materi DESC");
...
<body class="about-page">
  ...
  <main class="main">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Program Aplikasi<br></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container mt-3 mb-5">
      <div class="col-lg-12">
        <h3>Program Aplikasi</h3>
        <p>Merupakan Program Komputer yang langsung dapat dipergunakan untuk membantu kerja
          user (manusia) dalam pembuatan surat, tabel, perhitungan pembuatan grafik, persentasi
          mengolah data, membuat rangkaian/rancangan sederhana, membuat struktur orgnisasi, mengolah angka,
          membuat laporan, dll.</p>
      </div>
