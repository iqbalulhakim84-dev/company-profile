...
$mat_privat = mysqli_query($koneksi, "SELECT * FROM daftar_materi_privat");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Privat Mandiri Permateri<br></h1>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Privat Mandiri Permateri<br></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container justify-content-center mt-3 mb-5">
      <div class="col-lg-12 text-center">
        <h3>Daftar Biaya Privat Mandiri LPKII (Permateri)</h3>
      </div>
      <table border=1>
        <thead>
          <tr>
        ...
        <tbody>
          <?php
          $no = 0;
          while ($data = mysqli_fetch_assoc($mat_privat)) {
            $no++;
          ?>
            <tr>
              <td><?= $no; ?></td>
      ...
      <h3 class="text-center"><br>Daftar Biaya Privat Mandiri LPKII (Instalasi dan Administrasi Sistem)</h3>
