...
$pro_q = mysqli_query($koneksi, "SELECT * FROM promo ORDER BY id_promo DESC");
...
<body class="about-page">
  ...
  <main class="main">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Promo LPKII<br></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
    ...
    <h3 class="text-center mt-3"><b>PROMO LPKII</b></h3>
    <div class="container">
      <div class="row">
        <?php
        $no = 0;
        ...
        ?>
          <div class="col-md-4 mb-3 d-flex justify-content-center">
            <div class="p-2 border rounded shadow-sm" style="background: #f8f9fa;">
              <img src="assets/img/promo/<?php echo $data['gambar_promo']; ?>"
                class="img-fluid"
                style="max-width: 100%; height: auto;">
            </div>
          </div>
        <?php
          // Tutup dan buka row baru tiap 3 item
          if ($no % 3 == 0) {
