...
$result = mysqli_query($koneksi, "SELECT pk.id_paket_kursus,
       pk.kode,
       pk.nama_paket,
...
<body class="about-page">
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Kursus Reguler Per Paket<br></h1>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li><a href="paket">Paket Reguler</a></li>
            <li class="current">Pemrograman<br></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container mt-3 mb-5">
      <div class="col-lg-12">
        <h3>Pemrograman</h3>
        <p>Merupakan program komputer yang digunakan untuk membuat sebuah program aplikasi yang disesuaikan
          dengan kebutuhan pengguna (user) pada pekerjaan sehari-hari ataupun dalam berbagai bisnis baik kantor
          perusahaan, sekolah, rumah sakit, militer, pertanian, dll. Seperti digunakan dalam pengelolaan database
          karyawan akademik, penggajian/payroll, data stok barang, dll.</p>
      </div>
      ...
      <div class="container mt-3">
        <div class="row">
          <div class="col-lg-6 text-center">
            <h4 style="color:#fff; background-color:#000; border: 2px solid white;">PERSYARATAN</h4>
          ...
          <div class="col-lg-6 text-center">
            <h4 style="color:#fff; background-color:#000; border: 2px solid white;">FASILITAS</h4>
            <ol>
              <b>
